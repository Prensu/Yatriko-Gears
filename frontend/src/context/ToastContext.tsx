...
/**
 * Toast notifications — ported from the admin CMS pattern, adapted for the
 * public site's Tailwind colour tokens (forest/navy instead of ink/emerald).
 */
    ...
    <ToastContext.Provider value={value}>
      ...
      >
        {toasts.map((toast) => (
          <div
            key={toast.id}
            className={`pointer-events-auto flex animate-toast-in items-start gap-3 rounded-xl border px-4 py-3 shadow-lg shadow-slate-950/5 ${STYLES[toast.kind]}`}
          >
            <svg
